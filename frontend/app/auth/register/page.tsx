...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/auth/register', { 
        ...
        email, 
        password, 
        role: 'Citizen' // Default public registration role 
      });
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 text-center">Create an Account</h2>
      <p className="text-sm text-slate-500 dark:text-slate-400 text-center mb-8">Join Nivaran to file and track civic issues</p>
